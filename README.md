...
## React Sologram - a basic Instagram lite clone

In this project, I created an Instagram-like small app called Sologram.
it is a mobile-rst web app in React JS. The app allows users to browse a Home
Feed and Post a new image. 
...
The app has two tabs: the "Main Feed" and the "New Post" tabs
The user are able to Create new Posts, by copy-pasting an image URL and applying
CSS filters to such image (needs fixing). 
